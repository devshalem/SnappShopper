...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2025 at 03:44 PM
...
--
ALTER TABLE `recently_viewed_items`
  ADD CONSTRAINT `recently_viewed_items_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),
  ADD CONSTRAINT `recently_viewed_items_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`);
COMMIT;
